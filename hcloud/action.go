...
type ResourceWithPathID interface {
	PathID() string
}
...
// Please note that filters specified in opts are not taken into account
// when their value corresponds to their zero value or when they are empty.
func (c *ResourceActionClient) ListFor(ctx context.Context, resource ResourceWithPathID, opts ActionListOpts) ([]*Action, *Response, error) {
...
func (c *ResourceActionClient) AllFor(ctx context.Context, resource ResourceWithPathID, opts ActionListOpts) ([]*Action, error) {
	return iterPages(func(page int) ([]*Action, *Response, error) {
		opts.Page = page
