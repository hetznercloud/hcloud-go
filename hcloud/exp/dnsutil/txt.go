...
// FormatTXTValue splits a long string in chunks of 255 characters, and quotes each of
...
// ParseTXTValue joins multiple quoted strings into a single unquoted string.
//
// - "hello world"		=> hello world
// - "hello \"world\""	=> hello "world"
//
// This function can be reversed with [FormatTXTValue].
