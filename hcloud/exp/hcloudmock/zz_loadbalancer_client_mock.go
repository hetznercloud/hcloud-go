...
//
//	mockgen -package mock -destination zz_loadbalancer_client_mock.go -mock_names ILoadBalancerClient=LoadBalancerClient github.com/hetznercloud/hcloud-go/v2/hcloud ILoadBalancerClient
//
