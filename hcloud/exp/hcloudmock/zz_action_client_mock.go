...
//
//	mockgen -package mock -destination zz_action_client_mock.go -mock_names IActionClient=ActionClient github.com/hetznercloud/hcloud-go/v2/hcloud IActionClient
//
