...
//
//	mockgen -package hcloudmock -destination zz_loadbalancer_type_client_mock.go -mock_names ILoadBalancerTypeClient=LoadBalancerTypeClient github.com/hetznercloud/hcloud-go/v2/hcloud ILoadBalancerTypeClient
//
