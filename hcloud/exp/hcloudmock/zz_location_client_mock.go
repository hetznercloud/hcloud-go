...
//
//	mockgen -package mock -destination zz_location_client_mock.go -mock_names ILocationClient=LocationClient github.com/hetznercloud/hcloud-go/v2/hcloud ILocationClient
//
