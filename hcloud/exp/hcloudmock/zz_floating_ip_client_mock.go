...
//
//	mockgen -package hcloudmock -destination zz_floating_ip_client_mock.go -mock_names IFloatingIPClient=FloatingIPClient github.com/hetznercloud/hcloud-go/v2/hcloud IFloatingIPClient
//
