...
//
//	mockgen -package hcloudmock -destination zz_rdns_client_mock.go -mock_names IRDNSClient=RDNSClient github.com/hetznercloud/hcloud-go/v2/hcloud IRDNSClient
//
