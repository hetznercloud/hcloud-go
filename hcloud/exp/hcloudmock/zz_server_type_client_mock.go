...
//
//	mockgen -package hcloudmock -destination zz_server_type_client_mock.go -mock_names IServerTypeClient=ServerTypeClient github.com/hetznercloud/hcloud-go/v2/hcloud IServerTypeClient
//
