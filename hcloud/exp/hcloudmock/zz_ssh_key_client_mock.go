...
//
//	mockgen -package hcloudmock -destination zz_ssh_key_client_mock.go -mock_names ISSHKeyClient=SSHKeyClient github.com/hetznercloud/hcloud-go/v2/hcloud ISSHKeyClient
//
