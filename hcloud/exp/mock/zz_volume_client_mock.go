...
//
//	mockgen -package mock -destination zz_volume_client_mock.go -mock_names IVolumeClient=VolumeClient github.com/hetznercloud/hcloud-go/v2/hcloud IVolumeClient
//
