...
func ExampleResourceActionClient_ListFor() {
...

	{
		...
		result, _, _ := client.Server.Action.ListFor(ctx, &Server{ID: 14554235}, ActionListOpts{})
	...
	}
	{
		...
		result, _, _ := client.Zone.Action.ListFor(ctx, &Zone{Name: "example.org"}, ActionListOpts{})
		// Error handling skipped
